...
7. Настроим шлюз по умолчанию для возможности удаленного подклюения к коммутатру из других сетей (опционально, при наличии маршрутизатора)
...
В данном случае настроен шлюз по умолчанию 192.168.1.1 для доступа в другие сети (предполагая, что в будущем будет расширение сети, установлен маршрутизатор ). 
![](pc01.png)
...
S1#
```
Выполнена проверка параметров Vlan 1. Полоса пропускания BW 100000 Kbit.
