...
### 3. Документирование и реализация функций безопасности порта
...
Безопасность порта установлена только для двух MAC-адресов, а у порта 18 есть два “привязанных” MAC-адреса, привязанных к порту. Кроме того, для защиты от нарушений предусмотрена функция protect, которая никогда не отправит сообщение консоли/системного журнала и не увеличит счетчик нарушений.
